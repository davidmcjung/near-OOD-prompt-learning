...
do
    ...
    do
        ...
        do
            ...
            --config-file maple_based/configs/trainers/CoOp/vit_b16_ctxv1.yaml \
            --ood_method energy max_logit mcm \
            --output-dir output/${DATASET}/shots_${SHOTS}/CoOp/vit_b16_ctxv1/seed${SEED} \
            ...
            --dataset-config-file maple_based/configs/datasets/${DATASET}.yaml \
            --config-file maple_based/configs/trainers/CoOp/vit_b16_ctxv1.yaml \
            --model-dir output/${DATASET}/shots_${SHOTS}/CoOp/vit_b16_ctxv1/seed${SEED} \
            --output-dir output/${DATASET}/shots_${SHOTS}/CoOp_relative/vit_b16_ctxv1/seed${SEED} \
            --load-epoch 200 \
            --ood_method energy max_logit mcm \
            --eval-only \
            --empty_cls_prompt \

...
class OxfordPets(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        labels = list(labels)
        labels.sort()
        train = self.subsample_classes(train, labels=labels, subsample=cfg.DATASET.SUBSAMPLE_CLASSES)
        val_base, test_base = self.subsample_classes(val, test, labels=labels, subsample='base')
        val_new, test_new = self.subsample_classes(val, test, labels=labels, subsample='new')
    ...
    @staticmethod
    def subsample_classes(*args, labels, subsample="all", custom=False):

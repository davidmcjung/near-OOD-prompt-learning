...
class DescribableTextures(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        val_base, test_base = OxfordPets.subsample_classes(val, test, labels=labels, subsample='base')
        val_new, test_new = OxfordPets.subsample_classes(val, test, labels=labels, subsample='new')

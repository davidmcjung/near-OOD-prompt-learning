...
def reset_cfg(cfg, args):
    ...
    cfg.no_eval_near_ood = args.no_eval_near_ood
    cfg.empty_cls_prompt = args.empty_cls_prompt
...
if __name__ == "__main__":
    ...
    parser.add_argument("--empty_cls_prompt", action="store_true", help="")
    parser.add_argument("--no_eval_near_ood", action="store_true", help="")
